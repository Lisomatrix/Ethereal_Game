...
let DiscordOAuth2Service = class DiscordOAuth2Service {
    constructor(http) {
        this.http = http;
    }
    getUserInfo() {
        ...
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((info, index) => {
            this.userInfo = info;
            return info;
        }));
    }
...
DiscordOAuth2Service.ctorParameters = () => [
...
let HealthBarComponent = class HealthBarComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ShopButtonComponent = class ShopButtonComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
class Game {
    constructor(width, height, backgroundColor = 0xffffff, fillPage = false) {
        ...
        this.app.stage.on('mouseover', (x) => console.log(x));
        this.app.view.style.display = 'block';
        this.app.renderer.autoResize = true;
        if (fillPage) {
            this.app.renderer.resize(window.innerWidth, window.innerHeight);
        }
        Object(pixi_js__WEBPACK_IMPORTED_MODULE_0__["autoDetectRenderer"])({ width, height });
    }
    resize(width, height) {
...
/* harmony import */ var pixi_sound__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! pixi-sound */ "./node_modules/pixi-sound/dist/pixi-sound.esm.js");


// import {  } from 'pixi-sound';

pixi_sound__WEBPACK_IMPORTED_MODULE_2__["default"].Sound;
class Asteroid extends _Entity__WEBPACK_IMPORTED_MODULE_0__["Entity"] {
    ...
    loadTexture(loader) {
        this.sprite = new pixi_js__WEBPACK_IMPORTED_MODULE_1__["Sprite"](loader.resources[this.textureName].texture);
        this.hitSound = pixi_sound__WEBPACK_IMPORTED_MODULE_2__["default"].Sound.from('../assets/asteroid_hit.mp3');
    }
}
...
class Pickaxe extends _Entity__WEBPACK_IMPORTED_MODULE_0__["Entity"] {
    constructor() {
        super();
...
/* harmony import */ var _Entity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Entity */ "./src/models/Entity.ts");
/* harmony import */ var src_helpers_keyboardHelper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/helpers/keyboardHelper */ "./src/helpers/keyboardHelper.ts");


class Player extends _Entity__WEBPACK_IMPORTED_MODULE_0__["Entity"] {
    constructor(keyboardHelper) {
        super();
...
Player.ctorParameters = () => [
    { type: src_helpers_keyboardHelper__WEBPACK_IMPORTED_MODULE_1__["KeyboardHelper"] }
];
